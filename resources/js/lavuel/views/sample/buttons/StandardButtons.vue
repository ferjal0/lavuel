    ...
    <b-row>
      <b-col md="6">
        ...
        <b-card>
          ...
          <b-button variant="primary">
            <i class="icon-star icons" />&nbsp; Primary
          </b-button>
          <b-button variant="secondary">
            <i class="icon-power" />&nbsp; Secondary
          </b-button>
          <b-button variant="success">
            <i class="icon-magic-wand" />&nbsp; Success
          </b-button>
          <b-button variant="warning">
            <i class="icon-bulb" />&nbsp; Warning
          </b-button>
          <b-button variant="danger">
            <i class="icon-close" />&nbsp; Danger
          </b-button>
          <b-button variant="link">
            <i class="icon-cursor" />&nbsp; Link
          </b-button>
        </b-card>
        <b-card>
          <div slot="header">
